...
public class QuadDACPanelSearchIndexablesProvider extends SearchIndexablesProvider {
    private static final String TAG = "QuadDACPanelSearchIndexablesProvider";

    public static final int SEARCH_IDX_QUADDAC_PANEL = 0;

    private static SearchIndexableResource[] INDEXABLE_RES = new SearchIndexableResource[]{
            new SearchIndexableResource(1, R.xml.quaddac_panel,
                    QuadDACPanelFragment.class.getName(),
    ...
    private static Object[] generateResourceRef(SearchIndexableResource sir) {
        ...
        ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = "org.lineageos.settings.device.dac";
